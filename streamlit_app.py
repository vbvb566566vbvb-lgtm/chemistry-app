...
questions = [
    {"question": "عناصر يتتابع فيها امتلاء المستوى الفرعي 5d هي عناصر السلسلة الانتقالية:", "options": ["الأولى", "الثانية", "الثالثة", "الرابعة"], "answer": "الثالثة"},
    {"question": "تملأ عناصر السلسلة الانتقالية الأولى بالمستوى الفرعي:", "options": ["4d", "5d", "6d", "3d"], "answer": "3d"},
    {"question": "عند كتابة التوزيع الإلكتروني لعناصر السلسلة الانتقالية الأولى تملأ الإلكترونات:", "options": ["4s ثم 3d", "4s ثم 4d", "3d ثم 4s", "3d ثم 4p"], "answer": "4s ثم 3d"},
    {"question": "أي من العناصر التالية يعتبر عنصراً غير انتقالي؟", "options": ["Al", "Sc", "Au", "Ti"], "answer": "Al"},
    {"question": "يتم ملء المستوى الفرعي 5f في عناصر الدورة:", "options": ["الرابعة", "الخامسة", "السادسة", "السابعة"], "answer": "السابعة"},
    {"question": "التوزيع الإلكتروني لعنصر المنجنيز Mn25 هو:", "options": ["[Ar] 4s2 3d5", "[Ar] 4s0 3d7", "[Ar] 4s1 3d6", "[Ar] 4s2 3d5"], "answer": "[Ar] 4s2 3d5"},
    {"question": "عنصر الكروم Cr24 ينتمي للمجموعة:", "options": ["IIB", "IVB", "VIB", "VIIB"], "answer": "VIB"},
    {"question": "السلسلة الانتقالية الرئيسية الثانية تتبع الدورة ..... في الجدول الدوري", "options": ["الثالثة", "الخامسة", "الثانية", "الرابعة"], "answer": "الخامسة"},
    {"question": "العلاقة بين العنصرين Sc21 و Y39 هي أن كليها:", "options": ["عناصر مثالية", "لهما نفس المجموعة", "لهما نفس الدورة", "لافلزات"], "answer": "لهما نفس المجموعة"},
    {"question": "ينتمي عنصر الزيركونيوم Zr40 للمجموعة:", "options": ["IIB", "IIIB", "VB", "IVB"], "answer": "IVB"},
    {"question": "عناصر السلسلة الانتقالية تبدأ بعنصر La57 وتنتهي بعنصر Hg80", "options": ["الأولى", "الثانية", "الثالثة", "الرابعة"], "answer": "الثالثة"},
    {"question": "السلسلة الانتقالية الثانية تنتهي بعنصر:", "options": ["الكادميوم", "اللانثانيوم", "الخارصين", "الزئبق"], "answer": "الكادميوم"},
    {"question": "عناصر المجموعة IB هي عناصر انتقالية غالية الثمن", "options": ["VB", "IVB", "IIB", "IB"], "answer": "IB"},
    {"question": "عنصر انتقالي يستخدم في صناعة العملات المعدنية:", "options": ["Sc", "Cr", "Ti", "Cu"], "answer": "Cu"},
    {"question": "فلز غالي الثمن:", "options": ["Ne", "Pt", "Ag", "Ti"], "answer": "Pt"}
